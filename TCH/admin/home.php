...
include ('db.php');
if(isset($_GET['id'])){
    $temp = date('Y-m-d', strtotime(date('Y-m-d')));  
    $sql = "update roombook set Occupancy='$temp' where id=".$_GET['id']."";
									...
									{	
                                        ...
                                        if($co=="Confirm")
										{
											echo"<tr>
												...
												<th>".$trow['Movein']."</th>"
                                    ?>
                                    <th><input type="button" onclick="window.location.href='home.php?id=<?php echo $trow['id'];?>'"
                                    <?php
