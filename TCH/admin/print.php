...
@page { margin: 0; }
	...
	while($row=mysqli_fetch_array($re))
	{
		...
		$fintot = $row['fintot'];
									...
									// if($payment=="Room only")
									// {
									// 	$type_of_payment=$type_of_bed * 0;
									// }
									// else if($payment=="Daily")
									// {
									// 	$type_of_payment=$type_of_bed * 2;
									// }else if($payment=="Weekly")
									// {
									// 	$type_of_payment=$type_of_bed * 3;
									
									// }else if($payment=="Monthly")
									// {
									// 	$type_of_payment=$type_of_bed * 4;
									// }
	...
	?>
		<header>
			...
			<address >
				<p>TCH Tower,</p>
				<p>Sitapaila,  <br>Kathmandu,<br>Nepal,</p>
			...
			<table class="inventory">
				...
				<tbody>
					<tr>
						...
						<td><span ><?php echo $min; ?> </span></td>
						
						<td><span ><?php echo $room;?> </span></td>
						<td><span ><?php  echo $people;?></span></td>
						<td><span data-prefix>Rs. </span><span><?php echo $room; ?></span></td>
					</tr>
					<tr>
						<td><span ><?php echo $tbed; ?>  </span></td>
						<td><span ><?php echo $min; ?></span></td>
						<td><span ><?php echo $bed;?> </span></td>
						<td><span ><?php  echo $people?></span></td>
						<td><span data-prefix>Rs. </span><span><?php echo $bed; ?></span></td>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@swayambhuhotel.com || Phone :- 9802020063 </p>
			</div>
		</aside>
	</body>
</html>
